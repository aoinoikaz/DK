...
//     GameObject(std::string objName, std::string graphicFilePath)
//     {
...
//     GameObject(std::string objName, std::string graphicFilePath, std::vector<Animation> anims, Vector2 pos, Vector2 scale , float rot)
//     {
...
// Animation GetAnimationByName(GameObject* obj, std::string animationToFind)
// {
//     for(std::vector<Animation>::iterator it = obj->Animations.begin();
//         it != obj->Animations.end(); ++it)
//     {
//         if(strcmp((it)->Name.c_str(), animationToFind.c_str()) == 0)
//         {
//             return *it;
//         }
//     }
...
// void SwapAnimation(GameObject* obj, std::string path, std::string animName)
// {
//     std::cout << "Object: " << &obj;
//     std::cout << " Path: " << path;
